...
class OrderCancelAfter implements \Magento\Framework\Event\ObserverInterface
{
    ...
    public function execute(Observer $observer)
    {
        ...
        $isReturnSlot = $this->configHelper->getConfigReturnSlotCanceled();

        if ($ddateStoreModel->getData()) {
            $ddateStoreModel->setDeliveryStatus(\MW\Ddate\Model\Source\Ddate\DeliveryStatus::CANCELED);

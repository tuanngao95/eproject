...
/**
 * Class NotShippedCollection
 * @package MW\Ddate\Model\ResourceModel\Ddate\Order\Grid
 */
class NotShippedCollection extends \Magento\Sales\Model\ResourceModel\Order\Grid\Collection
{
    /**
     * {@inheritdoc}
     */
    protected function _initSelect()
    {
        ...
        if ($ddateId) {
            ...
            $ddateStores = $objectManager->create('MW\Ddate\Model\DdateStore')->getCollection()
                ...
                ->addFieldToFilter('delivery_status', array('eq' => 0));

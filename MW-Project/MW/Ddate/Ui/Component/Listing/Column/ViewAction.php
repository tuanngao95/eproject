...
namespace MW\Ddate\Ui\Component\Listing\Column;
...
/**
 * Class ViewAction
 * @package MW\Ddate\Ui\Component\Listing\Column
 */
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                if (isset($item[$this->getData('config/indexField')])) {
                    ...
                    $urlEntityParamName = $this->getData('config/urlEntityParamName') ?: 'ddate_id';

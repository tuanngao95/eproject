...
class LoadTime extends Action
{
    ...
    public function execute()
    {
        ...
        $delayDay = (int) ($this->configHelper->getConfigDelay()/24);
...
//        $startStoreDate = $this->_objectManager->create('Magento\Framework\Stdlib\DateTime\DateTime')->gmtDate('Y-m-d', '+'.$delayDay.' day');
        $startStoreDate = $this->_objectManager->create('Magento\Framework\Stdlib\DateTime\TimezoneInterface')->date('+'.$delayDay.' day')->format('Y-m-d');

...
/**
 * Class ShippedCollection
 * @package MW\Ddate\Model\ResourceModel\Ddate\Order\Grid
 */
class ShippedCollection extends \Magento\Sales\Model\ResourceModel\Order\Grid\Collection
{
    /**
     * {@inheritdoc}
     */
    protected function _initSelect()
    {
        ...
        if ($ddateId) {
            ...
            $ddateStores = $objectManager->create('MW\Ddate\Model\DdateStore')->getCollection()
                ...
                ->addFieldToFilter('delivery_status', array('eq' => 1));
